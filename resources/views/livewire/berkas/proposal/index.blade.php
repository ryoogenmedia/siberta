<div>
    <x-slot name="title">Berkas Proposal Mahasiswa</x-slot>

    <x-slot name="pageTitle">Berkas Proposal Mahasiswa</x-slot>

    <x-slot name="pagePretitle">Kelola data berkas proposal mahasiswa.</x-slot>
