<div>
    <x-slot name="title">Revisi Berkas Hasil</x-slot>

    <x-slot name="pagePretitle">Revisi Data Berkas Hasil Mahasiswa</x-slot>

    <x-slot name="pageTitle">Revisi Berkas Hasil</x-slot>

    <x-slot name="button">
        <x-datatable.button.back name="Kembali" :route="route('revision.hasil.index')" />
    </x-slot>
    ...
    <form class="card" wire:submit.prevent="edit" autocomplete="off">
        <div class="card-header">
            Revisi data berkas hasil mahasiswa
        </div>
